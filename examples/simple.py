...
gb = GBroke(wsurl = 'wss://ws-feed.gdax.com')       # Connects to a locally running TWS on port 7497 by default
instrument = gb.register("BTC-USD", on_bar, bar_size=30)     # Call `on_bar()` every 1 second with Bar namedtuple for Apple stock
...
gb.order_target(instrument,5.0)
